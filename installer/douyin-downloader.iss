#define MyAppName "抖音批量下载工具"
#define MyAppVersion "1.0.0"
#define MyAppExeName "抖音批量下载工具.exe"
...
[Icons]
Name: "{autoprograms}\抖音批量下载工具"; Filename: "{app}\{#MyAppExeName}"
Name: "{autodesktop}\抖音批量下载工具"; Filename: "{app}\{#MyAppExeName}"

[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "启动抖音批量下载工具"; Flags: nowait postinstall skipifsilent
